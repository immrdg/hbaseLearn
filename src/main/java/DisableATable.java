...
public class DisableATable {
    public static void main(String[] args) throws IOException {
        ...
        boolean isTableDisabled = admin.isTableDisabled(empTable);

        System.out.println(isTableDisabled); //false;

        if(!isTableDisabled){
            admin.disableTable(empTable);
        }
        System.out.println(admin.isTableDisabled(empTable));  // true
    }
}
